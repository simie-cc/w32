...
// Shell_NotifyIcon https://docs.microsoft.com/en-us/windows/desktop/api/shellapi/nf-shellapi-shell_notifyiconw
const (
	NIM_ADD        DWORD = 0x00000000
	NIM_MODIFY     DWORD = 0x00000001
	NIM_DELETE     DWORD = 0x00000002
	NIM_SETFOCUS   DWORD = 0x00000003
	NIM_SETVERSION DWORD = 0x00000004
)
const (
	NIF_MESSAGE  DWORD = 0x00000001
	NIF_ICON     DWORD = 0x00000002
	NIF_TIP      DWORD = 0x00000004
	NIF_STATE    DWORD = 0x00000008
	NIF_INFO     DWORD = 0x00000010
	NIF_GUID     DWORD = 0x00000020
	NIF_REALTIME DWORD = 0x00000040
	NIF_SHOWTIP  DWORD = 0x00000080
)
const (
...
// RedrawWindow() flags  https://source.winehq.org/source/include/winuser.h
const (
